...
export class EventEmitter<Template extends EventTemplateT = EventTemplateT> {
   ...
   * @param event
   */
  public listenerCount<Event extends TemplateEventT<Template>>(event: Event): number {
   ...
   * @param event
   */
  public removeAllListeners<Event extends TemplateEventT<Template>>(event?: Event): this {
    if (event === undefined) {
      this.events = {};
      return this;
    }
